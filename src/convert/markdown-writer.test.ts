...
describe("writeMarkdown", () => {
      ...
      sections: [
        {
          title: "Introduction",
          level: 2,
          content: [{ type: "paragraph", content: [{ type: "text", text: "Intro text." }] }],
          subsections: [],
        },
      ],
    });
      ...
      sections: [
        {
          title: "Results",
          level: 2,
          content: [{ type: "figure", label: "Figure 1", caption: "Score distribution" }],
          subsections: [],
        },
      ],
    });
      ...
      sections: [
        {
          title: "Results",
          level: 2,
          content: [{ type: "figure", label: "Figure 2" }],
          subsections: [],
        },
      ],
    });
          ...
          content: [
            {
              ...
              content: [
                { type: "text", text: "Visit " },
                {
                  ...
                  children: [{ type: "text", text: "our tool" }],
                },
          ...
          content: [
            {
              ...
              content: [
                { type: "text", text: "Available at " },
                {
                  ...
                  children: [{ type: "text", text: "https://www.r-project.org/" }],
                },
                { type: "text", text: "." },
              ],
            },
  ...
  it("renders reference DOI as clickable link", () => {
    const doc = makeDoc({
      references: [{ id: "ref1", text: "Smith J. Title. Journal. 2024.", doi: "10.1234/test" }],
    });
    const md = writeMarkdown(doc);
  ...
  it("renders reference PMID as clickable link", () => {
    const doc = makeDoc({
      references: [{ id: "ref1", text: "Smith J. Title. Journal. 2024.", pmid: "12345678" }],
    });
    const md = writeMarkdown(doc);
  ...
  it("renders reference PMCID as clickable link", () => {
    const doc = makeDoc({
      references: [{ id: "ref1", text: "Smith J. Title. Journal. 2024.", pmcid: "9876543" }],
    });
    const md = writeMarkdown(doc);
    expect(md).toContain(
  ...
  it("does not render pub-id links when none are present", () => {
    const doc = makeDoc({
      references: [{ id: "ref1", text: "Smith J. Title. Journal. 2024." }],
    });
    const md = writeMarkdown(doc);
    expect(md).toContain("1. Smith J. Title. Journal. 2024.");
          ...
          subsections: [
            {
              ...
              level: 3,
              content: [{ type: "paragraph", content: [{ type: "text", text: "Sub content." }] }],
              subsections: [],
            },
          ],
        },
          ...
          content: [
            {
              ...
              content: [
                {
                  type: "paragraph",
                  content: [{ type: "text", text: "Point 1: Important finding." }],
                },
                {
                  type: "paragraph",
                  content: [{ type: "text", text: "Point 2: Another finding." }],
                },
              ],
            },
          ],
      ...
      sections: [
        {
          title: "Equations",
          level: 2,
          content: [{ type: "formula", id: "eq1", label: "(1)", tex: "E = mc^2" }],
          subsections: [],
        },
      ],
    });
      ...
      sections: [
        {
          title: "Equations",
          level: 2,
          content: [{ type: "formula", label: "(2)", text: "x = y + z" }],
          subsections: [],
        },
      ],
    });
      ...
      sections: [
        {
          title: "Code",
          level: 2,
          content: [{ type: "preformat", text: 'function hello() {\n  return "world";\n}' }],
          subsections: [],
        },
      ],
    });
      ...
      sections: [
        {
          ...
          content: [
            { type: "paragraph", content: [{ type: "text", text: "See table and figure below." }] },
            {
              ...
              rows: [["Introduction<br>Explain purpose.", "Welcome participant."]],
            },
